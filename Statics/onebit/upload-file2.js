...
var OneBitImageUploader = {
    ...
    create: function (option) {
        ...
        var html = "<div class='upload_image_div' style='width:" + option.width + ";height:" + option.height + ";position: relative;'>" +
            ...
            "<img src='" + __root__ + "/Statics/onebit/redo.png' class='info-reset' style='width:20px;height:20px;position:absolute;right:0;top:0;border:0'>" + 
        ...
        if (option.type == 'upload') {
            ...
            if (crop != undefined) {
                ...
                //点击图片触发
              //.info-reset
                $(option.objDiv + ' .info-reset').click(function () {
                	
                	 $(option.objDiv + ' .info-cover').attr('src', option.emptySrc);
                     $(option.objDiv + ' input[name="' + option.inputFileName + '"]').val('');
                     $(option.objDiv + ' input[name="' + option.inputCoverName + '"]').val('');
                     $(option.objDiv + ' .info-cover-text').text(option.uploadTitle);
                    return false
                })
                $(option.objDiv + ' .upload_image').click(function () {
