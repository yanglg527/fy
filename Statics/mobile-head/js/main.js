var baseUrl= __url__;//baseUrl||"./js/";
require.config({
    //测试防止js文件缓存
    ...
    "tomLib":"tom.Lib",
     ...
     "lodash":"lodash",
        "jcanvas":"jcanvas",
        "hammer": __url__ + "/Hammer/hammer.min",
        "hammer.fake": __url__ + "/Hammer/hammer.fakemultitouch",
        "hammer.showtouch": __url__ +"/Hammer/hammer.showtouches",
