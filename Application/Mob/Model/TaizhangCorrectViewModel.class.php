...
class TaizhangCorrectViewModel extends BaseViewModel{
	protected $viewFields = array(
		'TaizhangCorrect' => array('id'=>'tdz_id','_type'=>'LEFT'),
        'Taizhang'=>array('*','_on'=>'Taizhang.id=TaizhangCorrect.taizhang_id','_type'=>'LEFT'),
