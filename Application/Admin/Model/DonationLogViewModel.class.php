...
class DonationLogViewModel extends BaseViewModel
{
    protected $viewFields = array(
        ...
        'PayOrder' => array('status'=>'order_status','pay_time'=>'order_pay_time', '_on'=>'DonationLog.order_id=PayOrder.id', '_type' => 'LEFT'),
        'User'=> array('realname'=>'user_realname', '_on'=>'DonationLog.uid=User.uid', '_type' => 'LEFT'),
    );
}