...
//        var_dump($_SESSION['wxpic']);
    ...
    public  function ajaxSaveTaizhang(){
        ...
        $userId = $user["uid"];
    //    file_put_contents('./taizhang.txt',$content);
        //判断是否有任务
        if($mission_id){
        ...
        =>$publishDate,"type"=>$type_id,"address"=>$address,'status'=>0,"party_name"=>$branch_name,"template_id"=>3,'publish_name'=>$publishName,'tz_content'=>$content,
