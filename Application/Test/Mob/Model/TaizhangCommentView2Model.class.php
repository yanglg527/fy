...
class TaizhangCommentView2Model extends BaseViewModel{
	protected $viewFields = array(
		...
		'User'=>array('realname'=>'user_realname','headimgurl'=>'user_headimgurl','_on'=>'User.uid=TaizhangComment.taizhang_uid','_type'=>'LEFT'),
