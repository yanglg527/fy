...
class PartyFeeViewModel extends BaseViewModel
{
    protected $viewFields = array(
        'PartyFee' => array('*', '_type'=>'LEFT'),
        'PartyBranch' => array('name'=>'branch_name', '_on'=>'PartyFee.branch_id=PartyBranch.id', '_type'=>'LEFT'),
