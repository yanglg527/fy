        ...
        var mdater = {
            ...
            renderHTML : function(){
                var $html = $('<div class="md_panel">' +
                    ...
                    '<a class="md_headtext daytag" href="javascript:void(0);"></a>' +
                    // '<a class="md_next change_month" href="javascript:void(0);"></a>' +
                    '</div>' +
                    '<div class="btn">'+
                    '<div onclick="trigger(this,1)" class="unfinish unfinished"><span>未完成</span><i></i></div>'+
                    '<div onclick="trigger(this,0)" class="finished unfinished hide"><i></i><span>体检扫描</span></div>'+
                    '</div></div>');
...
function getAjaxParam(){
    var year = $('.yeartag').attr('data-year');
    var month = parseInt($('.monthtag').attr('data-month'))+1;
    var param = {
        date:year + "-" + month,
        type: type > 0 ? 1 : 0
    }
