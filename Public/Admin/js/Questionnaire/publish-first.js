var addUrl = __root__ + "/Admin/Questionnaire/ajaxAddSubject";
var editTextUrl = __root__ + "/Admin/Questionnaire/ajaxEditText";
var editSingleUrl = __root__ + "/Admin/Questionnaire/ajaxEditSingle";
var editChoiceUrl = __root__ + "/Admin/Questionnaire/ajaxEditChoice";
var editBlankUrl = __root__ + "/Admin/Questionnaire/ajaxEditBlank";
var editAnswerUrl = __root__ + "/Admin/Questionnaire/ajaxEditAnswer";
var editTrueFalseUrl = __root__ + "/Admin/Questionnaire/ajaxEditTrueFalse";
var removeUrl = __root__ + "/Admin/Questionnaire/ajaxRemoveSubject";
var upUrl = __root__ + "/Admin/Questionnaire/ajaxUpSubject";
var downUrl = __root__ + "/Admin/Questionnaire/ajaxDownSubject";
var insertUrl = __root__ + "/Admin/Questionnaire/ajaxInsertSubject";
...
var editPublicScoreHtml =
    "<span class='score hide' style='margin-left: 10px'>分数：</span> " +
    "<select name='score' class='form-control hide' > " +
...
var editBlankScoreHtml =
    "<span class='score hide' style='margin-left: 10px'>每个填空：</span> " +
    "<select name='score' class='form-control hide' > " +
    "<option value='1' #score-1#>1分</option> " +
    "<option value='2' #score-2#>2分</option> " +
    "<option value='3' #score-3#>3分</option> " +
...
var editTrueFalseHtml =
    ...
    "<input placeholder='选项A' name='choice[]' class='form-control' value='正确' type='hidden'> " +
    "<label><input class='hide' type='radio' name='is_answer' value='0' #is_answer0#>正确</label> " +
    "</label> " +
    "</div> " +
    "<div class='radio'> " +
    "<label>" +
    "<input placeholder='选项B' name='choice[]' class='form-control'value='错误' type='hidden'> " +
    "<label><input type='radio' class='hide' name='is_answer' value='1' #is_answer1#>错误</label> " +
    "</label> " +
    "</div> " +
    "<div class='radio'> " +
    "<label>" +
...
var editSingleHtml =
    ...
    "<script type='text/plain' id='editor-single-#id#' style='text-align: left;    border: 1px solid #d4d4d4; border-radius: 4px;background-color:white;;padding:5px;width:100%'></script> " +
    "<button class='btn btn-info btn-xs image-insert' type='button' id='single-image-insert-#id#'>插入图片</button> " +
    "</div> " +
    "<textarea  class='hide' placeholder='问题' name='title' value='#title#'></textarea> " +
    "<textarea  class='hide' placeholder='remark' name='remark' value='#remark#'></textarea> " +
    "</div> " +
    ...
    "<div class='radio'> " +
    "<label>" +
    "A.<input placeholder='选项A' name='choice[]' class='form-control' value='#choiceA#'> " +
    "<label><input type='radio' class='hide' name='is_answer' value='0' #is_answer0#></label> " +
    "</label> " +
    "</div> " +
    "<div class='radio'> " +
    "<label>" +
    "B.<input placeholder='选项B' name='choice[]' class='form-control'value='#choiceB#'> " +
    "<label><input type='radio' class='hide' name='is_answer' value='1' #is_answer1#></label> " +
    "</label> " +
    "</div> " +
    "<div class='radio'> " +
    "<label>" +
    "C.<input placeholder='选项C' name='choice[]' class='form-control'value='#choiceC#'> " +
    "<label><input type='radio' class='hide' name='is_answer' value='2' #is_answer2#></label> " +
    "</label> " +
    "</div> " +
    "<div class='radio'> " +
    "<label>" +
    "D.<input placeholder='选项D' name='choice[]' class='form-control'value='#choiceD#'> " +
    "<label><input type='radio'  class='hide' name='is_answer' value='3' #is_answer3#></label> " +
    "</label> " +
    "</div> " +
    "</div> " +
    //"<h5 style='text-align: left'>解析：</h5>" +
...
var editChoiceHtml =
    ...
    "<label>" +
    "A.<input placeholder='选项A' name='choice[]' class='form-control' value='#choiceA#'> " +
    "<label><input type='checkbox' class='hide' name='is_answer[]' value='0' #is_answer0#></label> " +
    "</label> " +
    "</div> " +
    "<div class='radio'> " +
    "<label>" +
    "B.<input placeholder='选项B' name='choice[]' class='form-control'value='#choiceB#'> " +
    "<label><input type='checkbox' class='hide' name='is_answer[]' value='1' #is_answer1#></label> " +
    "</label> " +
    "</div> " +
    "<div class='radio'> " +
    "<label>" +
    "C.<input placeholder='选项C' name='choice[]' class='form-control'value='#choiceC#'> " +
    "<label><input type='checkbox' class='hide' name='is_answer[]' value='2' #is_answer2#></label> " +
    "</label> " +
    "</div> " +
    "<div class='radio'> " +
    "<label>" +
    "D.<input placeholder='选项D' name='choice[]' class='form-control'value='#choiceD#'> " +
    "<label><input type='checkbox' class='hide' name='is_answer[]' value='3' #is_answer3#></label> " +
    "</label> " +
    "</div> " +
    "</div> " +
    //"<h5 style='text-align: left'>解析：</h5>" +
